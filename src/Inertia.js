...
(function (global, factory) {
    ...
    var Inertia = function (ele, options) {
        ...
        if (ele.id && win.localStorage && (strStoreDistance = localStorage['Inertia_' + ele.id])) {
            ...
            endClass = localStorage['endClass']
        ...
        ele.addEventListener('touchstart', function (event) {
            ...
            if (endClass) ele.classList.remove(endClass)
            if (aniClass) ele.classList.remove(aniClass)
            aniClass = ''
        ...
        document.addEventListener('touchend', function () {
            ...
            var edge = function () {
                ...
                var run = function () {
                    ...
                    aniClass = 'ani'
                    ele.classList.add(aniClass)
                    fnTranslate(x, y);
                    // console.log(start, during);
                    if (start < during) {
                        ...
                        data.inertiaing = false;
                        if (win.localStorage) {
                            localStorage['endClass'] = endClass
                           localStorage['Inertia_' + ele.id] = [x, y].join();
                       }
                    }
                };
